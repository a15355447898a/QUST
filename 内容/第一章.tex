...
\caption{ (a) n型半导体能级图 (b) p型半导体能级图\\Fig. 1-1 Schematic illustration for the energy level of (a) n-type and (b) p-type semiconductor.}
...
\caption{ PN结形成的示意图\\Fig. 1-2 Schematic illustration for the formation of PN junction.}
